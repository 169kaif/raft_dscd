...
class Node(raft_pb2_grpc.ServicesServicer):
    ...
    def replicateLog(self,follower_id,isLeader=FALSE):
                ...
                try:
                    ...
                    if (response_current_term == self.current_term and self.current_role=="leader"):
                        if (response_success and response_ack >= self.acked_length[follower_id]):
                            ...
                            x=isLeader
                            self.replicateLog(follower_id,x)
...
if __name__ == '__main__':
    ...
    node_id = 5
    port = 5060
    peer_addresses = {2:"localhost:5057", 1:"localhost:5056", 3:"localhost:5058", 4:"localhost:5059"}
